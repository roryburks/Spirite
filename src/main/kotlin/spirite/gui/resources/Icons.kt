...
object SwIcons {
    ...
    fun loadIconSheet( resource: String) : BufferedImage {
        val stream = SwIcons::class.java.getClassLoader().getResourceAsStream(resource)
    ...
    enum class BigIcons(val ix: Int, val iy: Int) : IIcon {
        VisibleOn(0,0),
        VisibleOff(1,0),
        NewLayer(2,0),
        NewGroup(3,0),
    ...
    enum class SmallIcons(val ix: Int, val iy: Int) : IIcon {
