...
interface IAafFileSaver {
    fun saveAAF(ra: RandomAccessFile, animation: FixedFrameAnimation, aafInfo: AafInfo)
}
...
object AafFileSaver_3 : IAafFileSaver {
    override fun saveAAF(ra: RandomAccessFile, animation: FixedFrameAnimation, aafInfo: AafInfo)
    {
