...
class SystemMouseAdapter(val comp : JComponent) : MouseListener, MouseMotionListener
{
    ...
    fun convert(e: MouseEvent, type: MouseEventType) : sgui.generic.components.events.MouseEvent {
        val scomp = SwComponent(e.component as Component)
        val smask = e.modifiersEx
        val mask = sgui.generic.components.events.MouseEvent.toMask(
        ...
        return sgui.generic.components.events.MouseEvent(
